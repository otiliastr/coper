...
class _DataLoader(Loader):
        ...
        for seq1 in len_1_seqs:
            ...
            for seq2, seq2_e1 in gen:
                ...
                if subgraph_similarity > sim_threshold:
                    ...
                    sequence_similarities[seq1][seq2] = (subgraph_similarity, list(seq1_e2). list(seq2_e2))
    ...
    @staticmethod
    def get_indv_rel_seq_sims(e1_seq_set, e1_seq_e2_set, seq_threshold, seq_lengths, sim_threshold):
        number_relations_passed = 0
            ...
            with open(train_file, 'r') as handle:
                ...
                for line in handle:
                    ...
                    if '_reverse' not in sample['rel'].strip():
                        ...
                        seq_info = rel_seq_sim.get(lookup_pair, [((0, 0, 0), (1, 0, 0), 0.0, [])])
