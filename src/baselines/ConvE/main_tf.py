...
def main():
    ...
    for epoch in range(epochs):
        ...
        for i, str2var in enumerate(train_batcher):
            #print("The type of train_batcher is {}".format(train_batcher))
            #Uncomment for torch run
            #opt.zero_grad()
            e1 = str2var['e1']
            rel = str2var['rel']
            ...
            #print("The size of pred is: {}".format(pred.size()))
            #print("The size of e2_multi is: {}".format(e2_multi.size()))
            #BUG
            ...
            #print("The shape of the loss is {}".format(loss))
            #BUG
        ...
        #model.eval()
        #with torch.no_grad():
        ranking_and_hits(sess, model, dev_rank_batcher, vocab, 'dev_evaluation')
        if epoch % 3 == 0:
            if epoch > 0:
                ranking_and_hits(sess, model, test_rank_batcher, vocab, 'test_evaluation')
        #BUG
